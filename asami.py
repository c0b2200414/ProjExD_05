...
class Player(pg.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.imgs = [pg.transform.rotozoom(pg.image.load(f"ProjExD2023/ex05/fig/run{i}.png"), 0, 0.4) for i in range(1, 3)] 
        self.num = 1
...
def main():
    ...
    bg = pg.transform.rotozoom(pg.image.load("ProjExD2023/ex05/fig/background.png"), 0, 1.25)
    ...
    while True:
        ...
        for ojs in pg.sprite.groupcollide(objs, barrir, True, True).keys():
            pass
